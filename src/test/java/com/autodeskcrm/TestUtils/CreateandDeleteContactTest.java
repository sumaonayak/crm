...
public class CreateandDeleteContactTest extends WebDriverUtils {
	...
	public void contact() throws Throwable 
	{
		...
		String org_name = rd.fetchdata("org_name");
	...
	gm.alertOk(driver);
		...
		/*step11:select the organization*/
		 WebElement ele3 = driver.findElement(By.xpath("//a[.='qspiders']/../preceding-sibling::td[2]"));
		ele3.click();
		...
		gm.alertOk(driver);
		/*verify the element is deleted or not*/
	boolean flag1 = gm.waitForAnyElement(driver, ele3);
